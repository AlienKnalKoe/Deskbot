...
This repository contains the ESPHome configuration for **Deskbot**, based on the ESP32-4848S040 (Guition) hardware.
...
4. Compile and flash:
   ```bash
   esphome run Deskbot.yaml
   ```

## Project Structure
- `Deskbot.yaml`: Main ESPHome configuration.
